...
def fill_trainval_infos(data_path, nusc, train_scenes, val_scenes, test=False, max_sweeps=10,
                        only_accurate_localization=False, locations_subset=None):
    train_nusc_infos = []
    val_nusc_infos = []
    ...
    for index, sample in enumerate(nusc.sample
        ...
        # ref_sd_location_rec = ref_sd_rec['location_token']
        ...
        if locations_subset is None or ref_sd_rec['location_token'] in locations_subset:
            if sample['scene_token'] in train_scenes:
                # TODO: check if this token is in the sampled locations
