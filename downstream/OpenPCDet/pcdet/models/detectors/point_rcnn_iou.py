...
class PointRCNNIOU(Detector3DTemplate):
    '''
       Similar to PointRCNN except the training target is changed to IOU 
       The processing step is changed to ST3D post processing for compatibility
    '''
    ...
    def get_training_loss(self):
        ...
        if hasattr(self, 'history_query') and self.history_query is not None \
            ...
            loss = loss_point + loss_rcnn + loss_hist_query
        else:
    ...
    def post_processing(self, batch_dict):
        ...
        for index in range(batch_size):
            ...
            # batch box preds are changed by roi head
            # roi head would produce ious 
            # roi_scores would be class accuracy 
